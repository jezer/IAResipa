...
- [x] **Ação:** Configurar o Waha para integração com o WhatsApp (obtenção de credenciais, webhook para n8n).
...
- [x] **Ação:** Configurar as credenciais de acesso ao Supabase no n8n.
