...
def test_process_message_no_from_number(mocker, mock_message_details):
    ...
    mocker.patch('resipaia.codbackup.py_main_processor.handle_user_check')
    mocker.patch('resipaia.codbackup.py_main_processor.handle_reservation')
    mocker.patch('resipaia.codbackup.py_main_processor.handle_pix_initiation')
    mocker.patch('resipaia.codbackup.py_main_processor.handle_pix_status_check')
    mocker.patch('resipaia.codbackup.py_main_processor.handle_cancellation')
    mocker.patch('resipaia.codbackup.py_main_processor.handle_manage_reservations')
    mocker.patch('resipaia.codbackup.py_main_processor.handle_gemini_query')
    resipaia.codbackup.py_main_processor.handle_user_check.assert_not_called()
    resipaia.codbackup.py_main_processor.handle_reservation.assert_not_called()
    resipaia.codbackup.py_main_processor.handle_pix_initiation.assert_not_called()
    resipaia.codbackup.py_main_processor.handle_pix_status_check.assert_not_called()
    resipaia.codbackup.py_main_processor.handle_cancellation.assert_not_called()
    resipaia.codbackup.py_main_processor.handle_manage_reservations.assert_not_called()
    resipaia.codbackup.py_main_processor.handle_gemini_query.assert_not_called()
...
def test_process_message_body_and_text_handling(mocker, mock_message_details):
    ...
    resipaia.codbackup.py_main_processor.handle_user_check.assert_called_with({"from": "123456789", "body": "oi", "text": "oi"})

    message_details = {"from": "123456789@c.us", "body": "", "text": ""}
    response = process_message(message_details)
    assert message_details["body"] == ""
    assert message_details["text"] == ""
    resipaia.codbackup.py_main_processor.handle_gemini_query.assert_called_once_with({"from": "123456789", "body": "", "text": ""})